...
public class ArchonFrameBuilder implements ActionListener {

	private boolean showSaveWarning=true;
	private ArchonPanel archonpanel=new ArchonPanel();
	private String title="Archon Sim";
	private JMenu menu;
